...
$(pBlue ':: Change CLI Version :: Choose an option (by number): ') "
        read a
        case $a in
	        1) change_cli_ver "8.3" ; menu ;;
            2) change_cli_ver "8.2" ; menu ;;
	        3) change_cli_ver "8.1" ; menu ;;
	        4) change_cli_ver "8.0" ; menu ;;
	        5) change_cli_ver "7.4" ; menu ;;
	        6) change_cli_ver "7.3" ; menu ;;
	        7) change_cli_ver "7.2" ; menu ;;
	        8) change_cli_ver "7.1" ; menu ;;
	        9) change_cli_ver "7.0" ; menu ;;
	        10) change_cli_ver "5.6" ; menu ;;
		    0) menu ;;
...
$(pBlue ':: Choose an option (by number):  ') "
        read a
        case $a in
	        1) change_vhost_ver $1 "8.3" ; menu;;
            2) change_vhost_ver $1 "8.2" ; menu;;
	        3) change_vhost_ver $1 "8.1" ; menu;;
	        4) change_vhost_ver $1 "8.0" ; menu;;
	        5) change_vhost_ver $1 "7.4" ; menu;;
	        6) change_vhost_ver $1 "7.3" ; menu;;
	        7) change_vhost_ver $1 "7.2" ; menu;;
	        8) change_vhost_ver $1 "7.1" ; menu;;
	        9) change_vhost_ver $1 "7.0" ; menu;;
	        19) change_vhost_ver $1 "5.6" ; menu;;
		    0) change_vhost_menu ;;
...
sudo sed -i "s/post_max_size = .*/post_max_size = $size/" /etc/php/8.3/fpm/php.ini
sudo sed -i "s/post_max_size = .*/post_max_size = $size/" /etc/php/8.3/cli/php.ini
